...
export type FilterStateElement = {
...
interface ElementtypeFilterProps {
  onFilterChange: (filter: FilterStateElement) => void;
  onClose: () => void;
  currentFilter?: FilterStateElement;
}
export default function ElementtypeFilter({
  ...
  useEffect(() => {
    if (currentFilter) {
      ...
      setElementName(currentFilter.elementName || "");
  ...
  const handleApplyFilter = () => {
    const filter: FilterStateElement = {
      selectedTower,
      selectedStages,
      elementName,
      typeName,
